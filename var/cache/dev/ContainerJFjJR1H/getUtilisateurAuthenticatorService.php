...
class getUtilisateurAuthenticatorService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Security\\UtilisateurAuthenticator'])) {
            return $container->privates['App\\Security\\UtilisateurAuthenticator'];
        }

        return $container->privates['App\\Security\\UtilisateurAuthenticator'] = new \App\Security\UtilisateurAuthenticator($a);
    }
}
