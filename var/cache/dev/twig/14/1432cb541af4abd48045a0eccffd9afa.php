...
class __TwigTemplate_8fb9deba1e38783888584ee0bd8982ad extends Template
{
...
";
    ...
    ";
        ...
        <div class=\"metrics\">
            ...
            <div class=\"metric-group\">
                <div class=\"metric\">
                    <span class=\"value\">";
            // line 60
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 60, $this->source); })()), "templatecount", [], "any", false, false, false, 60), "html", null, true);
            yield "</span>
                ...
                <div class=\"metric\">
                    <span class=\"value\">";
            // line 65
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 65, $this->source); })()), "blockcount", [], "any", false, false, false, 65), "html", null, true);
            yield "</span>
                ...
                <div class=\"metric\">
                    <span class=\"value\">";
            // line 70
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 70, $this->source); })()), "macrocount", [], "any", false, false, false, 70), "html", null, true);
            yield "</span>
        ...
        <table id=\"twig-table\">
            ...
            $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 90, $this->source); })()), "templates", [], "any", false, false, false, 90));
            foreach ($context['_seq'] as $context["template"] => $context["count"]) {
                // line 91
                yield "                <tr>
                    ";
                // line 92
                $context["file"] = ((CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["collector"] ?? null), "templatePaths", [], "any", false, true, false, 92), $context["template"], [], "array", true, true, false, 92)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["collector"] ?? null), "templatePaths", [], "any", false, true, false, 92), $context["template"], [], "array", false, false, false, 92), false)) : (false));
                // line 93
                yield "                    ";
                ...
                if ((isset($context["link"]) || array_key_exists("link", $context) ? $context["link"] : (function () { throw new RuntimeError('Variable "link" does not exist.', 95, $this->source); })())) {
                    // line 96
                    yield "                            <a href=\"";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["link"]) || array_key_exists("link", $context) ? $context["link"] : (function () { throw new RuntimeError('Variable "link" does not exist.', 96, $this->source); })()), "html", null, true);
                    yield "\" title=\"";
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape((isset($context["file"]) || array_key_exists("file", $context) ? $context["file"] : (function () { throw new RuntimeError('Variable "file" does not exist.', 96, $this->source); })()), "html", null, true);
                    ...
                    // line 98
                    yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::default($this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->getFileRelative((isset($context["file"]) || array_key_exists("file", $context) ? $context["file"] : (function () { throw new RuntimeError('Variable "file" does not exist.', 98, $this->source); })())), (isset($context["file"]) || array_key_exists("file", $context) ? $context["file"] : (function () { throw new RuntimeError('Variable "file" does not exist.', 98, $this->source); })())), "html", null, true);
                    yield "</span>
                            </a>
                        ";
                } else {
    ...
    {
        return array (  322 => 113,  314 => 107,  305 => 104,  302 => 103,  296 => 101,  290 => 98,  286 => 97,  279 => 96,  277 => 95,  274 => 94,  271 => 93,  269 => 92,  266 => 91,  262 => 90,  239 => 70,  231 => 65,  223 => 60,  212 => 52,  206 => 48,  198 => 42,  195 => 41,  182 => 40,  167 => 35,  162 => 34,  149 => 33,  136 => 30,  133 => 29,  126 => 26,  119 => 22,  112 => 18,  105 => 14,  101 => 12,  99 => 11,  96 => 10,  89 => 7,  84 => 6,  81 => 5,  78 => 4,  65 => 3,  42 => 1,);
    }
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/twig.html.twig", "/home/ramand/Bureau/Copie de greenVillage/greenVillage19112024/vendor/symfony/web-profiler-bundle/Resources/views/Collector/twig.html.twig");
    }
}
