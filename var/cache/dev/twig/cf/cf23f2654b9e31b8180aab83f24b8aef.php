...
\t\t\t\t\t\t\t<td>";
        // line 26
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["userInfo"]) || array_key_exists("userInfo", $context) ? $context["userInfo"] : (function () { throw new RuntimeError('Variable "userInfo" does not exist.', 26, $this->source); })()), "prenom", [], "any", false, false, false, 26), "html", null, true);
        yield "</td> 
\t\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t";
        ...
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["userInfo"]) || array_key_exists("userInfo", $context) ? $context["userInfo"] : (function () { throw new RuntimeError('Variable "userInfo" does not exist.', 29, $this->source); })()), "roles", [], "any", false, false, false, 29));
        $context['loop'] = [
...
";
    ...
    {
        return array (  172 => 33,  157 => 31,  151 => 30,  134 => 29,  128 => 26,  124 => 25,  120 => 24,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% endblock %}
", "profil/update.html.twig", "/home/ramand/Bureau/Copie de greenVillage/greenVillage19112024/templates/profil/update.html.twig");
    }
}
